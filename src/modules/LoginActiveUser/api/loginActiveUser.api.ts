...
import { LoginActiveRequest, LoginActiveUserResponse } from '@modules/LoginActiveUser/api/types.ts';
...
export const loginActiveUserAPI = createApi({
  ...
  endpoints: (build) => ({
    loginActive: build.query<Response<LoginActiveUserResponse>, LoginActiveRequest>({
